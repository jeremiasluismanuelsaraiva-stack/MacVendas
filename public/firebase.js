...
async function loginUser(
    ...
    try {
        ...
        try {
            ...
            console.error(
                "[FIREBASE] Erro ao buscar Database:",
                erroDatabase
            );

            // =================================================
            // NÃO BLOQUEAR LOGIN POR CAUSA DO DATABASE
            // =================================================
        ...
        // Se não conseguiu obter do Database,
        // cria uma chave local temporária.
