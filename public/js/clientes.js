...
(function () {
    ...
    function iniciarCRM() {
        ...
        if (!tabela) {
            console.warn("[MOZ TECH] #tabelaClientes ainda não existe. O CRM será carregado quando o painel for aberto.");
            return false;
        }
    ...
    // Disponibiliza também uma função específica para o app.js
    window.iniciarCRM = iniciarCRM;

    // Tenta carregar quando o DOM estiver pronto.
    ...
    // quando o painel CRM for aberto, basta chamar iniciarCRM()
    // ou carregarClientes().
